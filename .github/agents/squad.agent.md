...
- **Version:** 0.8.23 (see HTML comment above — this value is stamped during install/upgrade). Include it as `Squad v0.8.23` in your first response of each session (e.g., in the acknowledgment or greeting).
